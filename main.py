...
from data_preprocessing.data_distribution import aggregate_data, create_uniform_distribution, z_score_normalization, \
    max_absolute_scaling, min_max_scaling, aggregate_trigger_points_for_emg_peak
...
if __name__ == '__main__':
    ...
    # emg_frames = aggregate_trigger_points_for_emg_peak(trigger_table, data.sample_rate, data.data_device1, frame_size=3)
    ...
    # save_train_test_split(train_data, test_data, 'fourier_shuffled')

    # train_data, test_data = load_train_test_split('fourier_shuffled')
