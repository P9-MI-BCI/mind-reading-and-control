...
class Dataset:
    ...
    def __init__(self, handle_arrow_rand=0, no_movements=0, time_cue_on=0, time_cue_off=0, TriggerPoint=0, delay_T1=0, delay_random_T1=0, delay_T2=0, sample_rate=0, time_window=0, no_time_windows=0, filter_code_eeg=0, time_start_device1=0, time_after_first_window=0, time_after_last_window=0, time_stop_device1=0, data_device1=pd.DataFrame, time_axis_all_device1=0, filtered_data=pd.DataFrame):
