...
class Simulation:
    ...
    def _check_heuristic(self):
        ...
        if sum(self.prev_pred_buffer) == 3:
    ...
    def _eval_performance(self):
        ...
        if not is_in_index:
            ...
            return self.iteration + self.dataset.sample_rate
    ...
    def _furthest_prediction_from_mrcp(self):
        ...
        get_logger().info(f'Total MRCP found in index for dataset: {len(self.dataset.onsets_index)}.')
